...
public class SecondFragment extends BaseFragment {
    ...
    @BindView(R.id.second_fragment_toolbar)
    Toolbar toolbar;

    @BindView(R.id.btn_go_deep)
    Button btnGoDeep;
    ...
    @OnClick(R.id.btn_go_deep)
    public void onDeepBtnClicked() {
        mNavController.navigateToSecondNestedFragment("");
    }
